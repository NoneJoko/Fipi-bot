...
def handle_all_messages(message):
    ...
    # Выбор Задание 1 — отправка голосового
    if message.text == 'Задание 1':
        state['task_num'] = '1'
        state['awaiting_answer'] = True
        send_voice_repeating(chat_id, delay=300)
        bot.send_message(chat_id, "Задание 1: Прослушайте изложение.\nПосле прослушивания введите свой ответ.", reply_markup=ReplyKeyboardRemove())
        return
    ...
    bot.send_message(chat_id, "Пожалуйстаk, выберите задание через кнопки или введите ответ на текущее задание.")
